# regression tests for the ksh93 builtin POSIX grep utilitiy #
...
TEST 01 '-q, -v combinations'
	...
	PROG type grep
		OUTPUT -e 'sed "s/ builtin.*/ builtin/"' - 'grep is a shell builtin'
	EXEC	-q . /dev/null
		OUTPUT -
		EXIT '[12]'
	EXEC	-q -v . /dev/null
...
TEST 14 '-m with -c, -h, -n, -t combinations'
	...
	EXEC	-TL -m -e open:{ -e close:} g6.dat g7.dat
		OUTPUT - $'g6.dat:open:{
g6.dat:open:	if(p==0){
g6.dat:close:	}
g6.dat:close:}
...
g7.dat:close:	}
g7.dat:close:}'
	EXEC	-Tm64Ki -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-Tm8Ki -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-Tm1Ki -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-m -e open:{ -e close:} g6.dat g7.dat

	EXEC	-TL -m -e include:include -e define:define g6.dat g7.dat
...
g7.dat:include:#include "sed.h" /* define sed stuff */'
	EXEC	-Tm64Ki -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-Tm8Ki -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-Tm1Ki -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-m -e include:include -e define:define g6.dat g7.dat

	EXEC	-TL -n -m -e open:{ -e close:} g6.dat g7.dat
...
g7.dat:67:close:	}
g7.dat:73:close:}'
	EXEC	-Tm64Ki -n -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-Tm8Ki -n -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-Tm1Ki -n -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-n -m -e open:{ -e close:} g6.dat g7.dat

	EXEC	-TL -n -m -e include:include -e define:define g6.dat g7.dat
...
g7.dat:3:include:#include "sed.h" /* define sed stuff */'
	EXEC	-Tm64Ki -n -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-Tm8Ki -n -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-Tm1Ki -n -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-n -m -e include:include -e define:define g6.dat g7.dat

	EXEC	-TL -c -m -e open:{ -e close:} g6.dat g7.dat
		OUTPUT - $'g6.dat:open:227
g6.dat:close:231
g7.dat:open:9
g7.dat:close:9'
	EXEC	-Tm64Ki -c -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-Tm8Ki -c -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-Tm1Ki -c -m -e open:{ -e close:} g6.dat g7.dat

	EXEC	-TL -c -m -e include:include -e define:define g6.dat g7.dat
		OUTPUT - $'g6.dat:include:54
g6.dat:define:5
g7.dat:include:1
g7.dat:define:0'
	EXEC	-Tm64Ki -c -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-Tm8Ki -c -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-Tm1Ki -c -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-c -m -e include:include -e define:define g6.dat g7.dat

	EXEC	-TL -h -m -e open:{ -e close:} g6.dat g7.dat
		OUTPUT - $'open:{
open:	if(p==0){
close:	}
close:}
...
close:	}
close:}'
	EXEC	-Tm64Ki -h -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-Tm8Ki -h -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-Tm1Ki -h -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-h -m -e open:{ -e close:} g6.dat g7.dat

	EXEC	-TL -h -m -e include:include -e define:define g6.dat g7.dat
...
include:#include "sed.h" /* define sed stuff */'
	EXEC	-Tm64Ki -h -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-Tm8Ki -h -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-Tm1Ki -h -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-h -m -e include:include -e define:define g6.dat g7.dat

	EXEC	-TL -c -h -m -e open:{ -e close:} g6.dat g7.dat
		OUTPUT - $'open:227
close:231
open:9
close:9'
	EXEC	-Tm64Ki -c -h -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-Tm8Ki -c -h -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-Tm1Ki -c -h -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-c -h -m -e open:{ -e close:} g6.dat g7.dat

	EXEC	-TL -c -h -m -e include:include -e define:define g6.dat g7.dat
		OUTPUT - $'include:54
define:5
include:1
define:0'
	EXEC	-Tm64Ki -c -h -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-Tm8Ki -c -h -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-Tm1Ki -c -h -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-c -h -m -e include:include -e define:define g6.dat g7.dat

	EXEC	-TL -t -m -e open:{ -e close:} g6.dat g7.dat
		OUTPUT - $'open:236
close:240'
	EXEC	-Tm64Ki -t -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-Tm8Ki -t -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-Tm1Ki -t -m -e open:{ -e close:} g6.dat g7.dat
	EXEC	-t -m -e open:{ -e close:} g6.dat g7.dat

	EXEC	-TL -t -m -e include:include -e define:define g6.dat g7.dat
		OUTPUT - $'include:55
define:5'
	EXEC	-Tm64Ki -t -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-Tm8Ki -t -m -e include:include -e define:define g6.dat g7.dat
	EXEC	-Tm1Ki -t -m -e include:include -e define:define g6.dat g7.dat
