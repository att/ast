...
const char sh_optgetopts[] =
    ...
    "[-author?Glenn Fowler <gsf@research.att.com>]" USAGE_LICENSE
...
const char sh_optbg[] = "[-1c?@(#)$Id: bg (AT&T Research) 2000-04-02 $\n]" USAGE_LICENSE
...
const char sh_optfg[] = "[-1c?@(#)$Id: fg (AT&T Research) 2000-04-02 $\n]" USAGE_LICENSE
...
const char sh_optdisown[] = "[-1c?@(#)$Id: disown (AT&T Research) 2000-04-02 $\n]" USAGE_LICENSE
...
const char sh_optkill[] =
    ...
    "message number than can only be as large as a signed integer.  "
    "The \ajob\a must be specified as a positive number. "
    "On systems that do not support \asigqueue\a(2), a signal "
    "is sent without the message number \an\a and the signal will not be queued.]"
...
const char sh_optlet[] = "[-1c?@(#)$Id: let (AT&T Research) 2000-04-02 $\n]" USAGE_LICENSE
