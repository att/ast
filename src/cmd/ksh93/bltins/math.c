...
static Sfdouble_t local_float(Sfdouble_t a1) {
    return a1;
}

static int local_fpclassify(Sfdouble_t a1) {
    return fpclassify(a1);
}
...
static int local_isgreater(Sfdouble_t a1, Sfdouble_t a2) {
    return isgreater(a1, a2);
}

static int local_isgreaterequal(Sfdouble_t a1, Sfdouble_t a2) {
    return isgreaterequal(a1, a2);
}
...
static int local_isless(Sfdouble_t a1, Sfdouble_t a2) {
    return isless(a1, a2);
}

static int local_islessequal(Sfdouble_t a1, Sfdouble_t a2) {
    return islessequal(a1,a2);
}

static int local_islessgreater(Sfdouble_t a1, Sfdouble_t a2) {
    return islessgreater(a1, a2);
}
...
static int local_isunordered(Sfdouble_t a1, Sfdouble_t a2) {
    return isunordered(a1, a2);
}
...
static Sfdouble_t local_j0(Sfdouble_t a1) {
    return j0(a1);
}

static Sfdouble_t local_j1(Sfdouble_t a1) {
    return j1(a1);
}

static Sfdouble_t local_jn(Sfdouble_t a1, Sfdouble_t a2) {
    return jn(a1, a2);
}
...
static Sfdouble_t local_scalb(Sfdouble_t a1, Sfdouble_t a2) {
    return scalb(a1, a2);
}
...
static Sfdouble_t local_y0(Sfdouble_t a1) {
    return y0(a1);
}

static Sfdouble_t local_y1(Sfdouble_t a1) {
    return y1(a1);
}

static Sfdouble_t local_yn(Sfdouble_t a1, Sfdouble_t a2) {
    return yn(a1,a2);
}
