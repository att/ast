...
# When calling a function inside of command substitution and the function 
# both opens and closes the file descriptor "3", the output generated by 
# the function is not returned as a result of the command substitution.
...
[[ $(run_in_subshell) == 'ok' ]] || err_exit "Output generated in a function inside subshell is not captured"
