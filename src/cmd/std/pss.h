...
#define PSS_all                                                                               \
    (PSS_addr | PSS_args | PSS_command | PSS_cpu | PSS_flags | PSS_gid | PSS_job | PSS_nice | \
     PSS_npid | PSS_pgrp | PSS_pid | PSS_ppid | PSS_pri | PSS_proc | PSS_refcount | PSS_rss | \
     PSS_sched | PSS_sid | PSS_size | PSS_start | PSS_state | PSS_tgrp | PSS_time | PSS_tty | \
     PSS_uid | PSS_wchan)
...
#define pssinit(d, c, e)                                                                 \
    (memset(d, 0, sizeof(*(d))), (d)->version = PSS_VERSION, (d)->command = (char *)(c), \
     (d)->errorf = (Error_f)(e))
