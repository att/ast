...
static int aixclose(Ardir_t *ar) {
    State_t *state;
...
static int aixopen(Ardir_t *ar, char *buf, size_t n) {
    Header_t *hdr;
    State_t *state;
    long m;
...
static Ardirent_t *aixnext(Ardir_t *ar) {
...
static int aixchange(Ardir_t *ar, Ardirent_t *ent) {
    State_t *state = (State_t *)ar->data;
    off_t o;
...
Ardirmeth_t ar_aix = {"aix", "aix archive", aixopen,    aixnext, aixchange, 0,
