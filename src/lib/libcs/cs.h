...
#define CS_REMOTE_PROFILE                                                                      \
    "set true; $1 eval 'unset true eval; source ./.login >& /dev/null < /dev/null'; set eval " \
    "CsH=true; $1 $CsH 'shift; shift; . ./.profile >/dev/null 2>&1 </dev/null'"
...
extern void csserve(Cs_t *, void *, const char *, void *(*)(void *, int), int (*)(void *, int),
                    int (*)(void *, int, Csid_t *, int, char **), int (*)(void *, int),
...
extern void _cs_serve(void *, const char *, void *(*)(void *, int), int (*)(void *, int),
                      int (*)(void *, int, Csid_t *, int, char **), int (*)(void *, int),
                      int (*)(void *, int), int (*)(void *));
