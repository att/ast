...
iffe_tests=( 'api' 'aso' 'ccode' 'common' 'float' 'fs' 'iconv' 'lib' 'syslocale' 'mmap' 'ndbm' 'prog' 'sfio' 'siglist' 'sizeof' 'standards' 'sys' 'sys_calls' 'tmlib' 'tty' 'tv' 'tvlib' 'vfork' 'vmalloc' 'wait')
