...
iffe_tests=( 'api' 'aso' 'ccode' 'common' 'float' 'fs' 'iconv' 'lib' 'locale' 'mmap' 'ndbm' 'options' 'prog' 'sched' 'sfio' 'siglist' 'sizeof' 'spawn' 'standards' 'sys' 'sys_calls' 'time' 'tmlib' 'tty' 'tv' 'tvlib' 'vfork' 'vmalloc' 'wait')
